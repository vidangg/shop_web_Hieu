...
public class OrderServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if (cU == null) {
            ...
            List<Order> listO = new OrderDAO().getOrderByUserId(cU.getId());
    ...
    throws ServletException, IOException {
        ...
        if (u != null) {
            ...
            if(action.equals("accept")) {
                new OrderDAO().updateOrder(orderId, "completed");
                response.sendRedirect("order");
            } else if (action.equals("cancle")) {
                new OrderDAO().updateOrder(orderId, "cancelled");
                List<Order_item> listOI = new OrderItemDAO().getOrderItemByOrderId(orderId);
                ...
                new UserDAO().updateUserMoney(u.getId(), new BigDecimal(-order.getTotal()));
